...
export default class MultiSlider extends React.Component {
  ...
  render() {
    ...
    let positionOneB = positionOne<positionOneA?positionOneA:(positionOne>positionTwoA?positionTwoA:positionOne);
    let positionTwoB = positionTwo>positionTwoA?positionTwoA:(positionTwo<positionOneA?positionOneA:positionTwo);

    const trackOneLength = positionOneB;
    const trackOneLengthA = positionOneA;
    const trackOneStyle = twoMarkers
      ? unselectedStyle
      : selectedStyle || styles.selectedTrack;
    const trackThreeLength = twoMarkers ? sliderLength - positionTwoB : 0;
